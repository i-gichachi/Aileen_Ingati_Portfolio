...
const PILLAR_META: Record<string, { metric?: string; metricLabel?: string; credential?: string }> = {
    'ip-strategy': { metric: '28%', metricLabel: 'WIPO Patent Grant Rate' },
    'judicial-research': { metric: '85%', metricLabel: 'Governance Resolution Rate' },
    'data-protection': { credential: 'CIPIT Certified' },
}

const ORDER = ['ip-strategy', 'judicial-research', 'data-protection']
        ...
        >
            ...
            <div
                style={{
                    ...
                    width: '45%',
                    height: '100%',
                    background: 'radial-gradient(circle at 90% 30%, rgba(160,120,74,0.06) 0%, transparent 60%)',
                    pointerEvents: 'none',
                    zIndex: 0,
                }}
            />
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                >
                    ...
                    >
                        Protecting, commercialising and enforcing intellectual assets across local and
                        international jurisdictions, from patent prosecution to data governance.
                    </p>
                    <motion.div
                        initial={{ scaleX: 0 }}
