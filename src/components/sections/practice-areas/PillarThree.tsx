...
const PILLAR_META: Record<string, { metric?: string; metricLabel?: string; credential?: string }> = {
    'corporate-governance': { metric: '85%', metricLabel: 'Governance Resolution Rate' },
    'regulatory-compliance': { credential: 'Board Member KIPI' },
    'capacity-building': { credential: '250+ Stakeholders Trained' },
}

const ORDER = ['corporate-governance', 'regulatory-compliance', 'capacity-building']
...
export default function PillarThree() {
    ...
    return (
        <section
            ...
            style={{ backgroundColor: '#FAF8F3', paddingTop: '5rem', paddingBottom: '6rem' }}
        >
            {/* Subtle ambient orb */}
            <div
                style={{
                    ...
                    height: '70%',
                    background:
                        'radial-gradient(circle at 0% 100%, rgba(160,120,74,0.06) 0%, transparent 60%)',
                    pointerEvents: 'none',
                    zIndex: 0,
                }}
            />
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                >
                    ...
                    >
                        Building institutional accountability through compliance frameworks, board advisory and
                        stakeholder engagement across corporate, public sector and development organisation
                        contexts.
                    </p>
                    <motion.div
                        initial={{ scaleX: 0 }}
